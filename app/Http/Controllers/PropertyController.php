...
class PropertyController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('dashboard.create', compact('categories', 'propertyTypes', 'cities', 'agents', 'facilities', 'districts'));
    }
    ...
    public function edit(Property $property): View
    {
        ...
        return view('dashboard.edit', compact('property', 'categories', 'propertyTypes', 'cities', 'agents', 'facilities', 'districts'));
    }
